...
- ✅ 5 готовых макетов размещения изображений
...
Система включает 5 предустановленных макетов размещения изображений:
...
5. **three_stack** — три изображения друг под другом
...
| Поле | Тип | Описание |
|------|-----|----------|
| `layout_type` | string | Тип макета (single_wide, two_stack и т.д.) |
