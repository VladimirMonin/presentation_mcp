...
- ✅ Поддержка GIF (включая анимированные)
- ✅ **НОВОЕ v2.0!** Добавление аудио с автоматическим воспроизведением
...
Система построена на принципе **Composition over Inheritance** для гибкости и расширяемости.

### Основные компоненты

- **PresentationBuilder** — оркестратор сборки презентации
- **ImagePlacer** — размещение изображений (WebP конвертация, масштабирование, GIF)
- **MediaPlacer** — добавление аудио/видео с автозапуском

**Подробная техническая документация:** [`doc/technical/`](technical/)

---

**Дата обновления:** 20 ноября 2025  
**Версия:** 2.0 (Рефакторинг архитектуры + автозапуск аудио)
